...
public abstract class Formats {
     ...
     *
     */
    public static Formats SIMPLEDATE = new FormatsSIMPLEDATE();

    /**
     *
     */
    public static Formats SQLDATE = new FormatsSQLDATE();
    ...
    private static NumberFormat m_currencyformat =new DecimalFormat("#,##0.## "+vars.getMoneySymble());// NumberFormat.getCurrencyInstance();
    ...
    private static DateFormat m_sqldate = new SimpleDateFormat("yyyy-MM-dd");
	...
	protected Date parseValueInt(String value) throws ParseException {
	 return m_hourminformat.parse(value);
        ...
        private static final class FormatsSQLDATE extends Formats {

             @Override
         protected String formatValueInt(Object value) {

             return m_sqldate.format(value);
